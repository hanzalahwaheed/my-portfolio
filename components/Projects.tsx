...
const jobProjects = [
	...
	},
	{
		...
		description:
			"The portfolio webpage you are looking at right now. Based on Brittany Chiang's website. Coded in Visual Studio Code.",
				...
				{jobProjects.map((project, index) => (
					<a
						...
						<Card className="group mb-4 flex min-h-fit w-full flex-col gap-0 border-transparent hover:border lg:flex-row lg:gap-5 lg:p-6 lg:hover:border-t-blue-200 lg:hover:bg-slate-100/50 lg:hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] lg:hover:drop-shadow-lg dark:lg:hover:border-t-blue-900 dark:lg:hover:bg-slate-800/50">
							<CardHeader className="mb-4 h-full w-full p-0 lg:w-1/3">
								<Image
									...
									height={1080}
									priority
									className="mt-2 rounded-[0.5rem] border border-muted-foreground bg-[#141414]"
								/>
							</CardHeader>
							<CardContent className="flex w-full flex-col p-0 lg:w-2/3">
